...
class HandleReturn extends \Mobipaid\Mobipaid\Controller\Payment\Index
{
    /**
    ...
    public function execute()
    {
        ...
        if (isset($additionalInformation['mobipaid_status'])) {
            if ($additionalInformation['mobipaid_status'] == "canceled") {
            ...
            $payment->setAdditionalInformation('mobipaid_transaction_id', $transaction_id);
            ...
            $message = __('Your order on').' '.
                ...
                __('Please back again after a minutes and check your order history", "Please back again after a minutes and check your order history');
