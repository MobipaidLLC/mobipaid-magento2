...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if (isset($responseStatus['status'])) {
            if ($responseStatus['status'] == \Mobipaid\Mobipaid\Model\Method\AbstractMethod::FAILED_STATUS) {
                $failedReasonCode = '';
    ...
    public function saveAdditionalInformation($order, $responseStatus)
    {
        ...
        if (isset($responseStatus['payment_id'])) {
            $payment->setAdditionalInformation('mobipaid_payment_id', $responseStatus['payment_id']);
        }
        if (isset($responseStatus['transaction_id'])) {
            $payment->setAdditionalInformation('mobipaid_transaction_id', $responseStatus['transaction_id']);
        }
        if (isset($responseStatus['amount'])) {
            $payment->setAdditionalInformation('mobipaid_amount', $responseStatus['amount']);
        }
        if (isset($responseStatus['result'])) {
            $payment->setAdditionalInformation('mobipaid_result', $responseStatus['result']);
        }
        if (isset($responseStatus['currency'])) {
            $payment->setAdditionalInformation('mobipaid_currency', $responseStatus['currency']);
        }
        if (isset($responseStatus['result_code'])) {
            $payment->setAdditionalInformation('mobipaid_result_code', $responseStatus['result_code']);
        }
        if (isset($responseStatus['status'])) {
            $payment->setAdditionalInformation('mobipaid_status', $responseStatus['status']);
        }
